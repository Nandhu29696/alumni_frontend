...
(()=>{
    const e = new Error("Cannot find module '../components/DirectoryScreen'");
...
function Home() {
    ...
    if (!selectedEvent && !selectedPerson && active === 'Alumni directory') screen = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DirectoryScreen, {
        people: people,
        query: query,
        setQuery: setQuery,
        onOpen: openPerson,
...
_s(AdminScreen, "n9SbKlhpHUAugZKvqikOAnfSTVM=");
_c = AdminScreen;
var _c;
...
//# sourceMappingURL=_0p2kghe._.js.map